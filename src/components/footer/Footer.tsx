    ...
    return (<footer className="bg-black text-white w-full min-h-[450px]">
        <div className="text-center relative pt-[1rem] lg:pt-[4rem] after:content-[''] after:block after:w-[90%] after:h-[2px] after:bg-white after:mx-auto after:mt-2">
            ...
            <ul className="gap-[2rem] px-[0.5rem] ">
                ...
                <li className="mb-[1rem]"><Link href="" className="flex md:flex-row flex-col"><svg className="md:mr-[1rem] mr-0" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M22 4H2V20H22V4ZM20 8L12 13L4 8V6L12 11L20 6V8Z" fill="white"/>
                ...
                <li><Link href="" className="flex md:flex-row flex-col"><svg className="md:mr-[1rem] mr-0" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
